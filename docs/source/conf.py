...
nbsphinx_thumbnails = {
    'examples/_notebooks/KBMOD_Demo': '_static/examples__notebooks_KBMOD_Demo.png',
    ...
    'examples/_notebooks/reprojection/reproject_demo': '_static/examples__notebooks_reproject_demo.png',
    'examples/_notebooks/TrajectoryExplorer': '_static/examples__notebooks_TrajectoryExplorer.png',
}
