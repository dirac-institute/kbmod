...
class ImageCollector:
    ...
    def get_collection_sizes(self, datasetType, collection_names=None, collection_regex=None):
        """
        ...
        if collection_names is None:
            ...
            collection_names = [col for col in all_collections if re.match(collection_regex, col)]
