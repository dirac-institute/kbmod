...
class test_psi_phi_array(unittest.TestCase):
    ...
    def test_set_meta_data(self):
        ...
        # Make float
        arr.set_meta_data(self.num_times, self.height, self.width)
    ...
    def test_fill_psi_phi_array(self):
        ...
        fill_psi_phi_array(arr, [self.psi_1, self.psi_2], [self.phi_1, self.phi_2], self.zeroed_times)
    ...
    def test_fill_psi_phi_array_from_image_stack(self):
        ...
        arr = PsiPhiArray()
        fill_psi_phi_array_from_image_stack(arr, im_stack)
