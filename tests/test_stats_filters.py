...
class test_basic_filters(unittest.TestCase):
    ...
    def test_combined_stats_filter(self):
        ...
        self.assertEqual(f.get_filter_name(), "CombinedStats_10_5.0_inf")
        ...
        for row in self.rs.results:
            ...
            self.assertGreaterEqual(len(row.final_likelihood), 5.1)

    def test_duration_filter(self):
        f = DurationFilter(self.times, 5.1)
        self.assertEqual(f.get_filter_name(), "Duration_9.1")
